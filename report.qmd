...
The ages of the actors, rather than that of their characters, were measured (on the first day of screening). This study took observations of films spanning 30 years (1984-2014), over this time period the average age gaps was approximately 4.5 years with the largest average gap being in 1984 (men were 10.4 years older) and the smallest average gap in 1988 (men were  0.6 years older). At no point in the 30 year timeframe were the average age of female leads older than male counter parts. 

It is worth noting that the age gap was smaller on films directed by women during the time period (12% of all films studied). This is very similar to our study in that it focuses on bringing to light the gender inequality in the Hollywood film industry through data.
...
-   We would also like to look at data that includes films from other regions of the world with large film industries such as Europe or India in order be able to see if any cultural nuance can be currently or historically in the portrayal of couples.
