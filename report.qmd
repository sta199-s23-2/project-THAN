...
```{r}
est_mu_overall <- 10.36572
est_sigma_overall <- sd(Agegaps_hetero$age_difference , na.rm = T) / sqrt(1132)
qnorm(c(0.025, 0.975), est_mu_overall, est_sigma_overall)
